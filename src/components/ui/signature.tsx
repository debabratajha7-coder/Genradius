...
interface SignatureProps {
  ...
  fontUrl?: string;
  /** Tighter vertical box for headers / small slots */
  compact?: boolean;
}
...
export function Signature({
  ...
  const height = compact ? fontSize * 1.35 : fontSize * 3;
  const horizontalPadding = fontSize * 0.08;
  const baseline = compact ? fontSize * 1.05 : fontSize * 1.5;
